...
const API_KEY = "https://api.openweathermap.org/data/3.0/onecall?lat={lat}&lon={lon}&exclude={part}&appid={API key}"; // Paste your API here
...
//built a web page that fetches weather data from weather API based on user location or a user inputted location. Display the current weather condition,temperature,and other relavant information.                